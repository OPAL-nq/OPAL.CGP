...
export default function CalculatingScreen({ onComplete }: CalculatingScreenProps) {
  ...
  const steps = [
    "Analyse de votre capacité opérationnelle...",
    "Analyse de vos processus documentaires & relances...",
    "Évaluation de votre capacité d'absorption client...",
    "Identification de votre principal point de friction...",
  ];
    ...
    <div className="py-12 sm:py-16 text-center space-y-8 max-w-md mx-auto animate-in fade-in duration-300">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted">
          Calcul des 4 dimensions et modélisation de votre indice de capacité.
        </p>
      </div>
